...
module.exports = jQuery;}, "spine/index": function(exports, require, module) {module.exports = require('./lib/spine');}, "spine/lib/spine": function(exports, require, module) {// Generated by CoffeeScript 1.3.3
(function() {
...
(function() {
...
}, "controllers/Games": function(exports, require, module) {(function() {
  var Games, Spine,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  var Game, Games, Main, Player, Sidebar, SidebarFooter, Spine,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  Main = (function(_super) {
    ...
    function Main() {
      ...
      this.sidebar.list.active();
      this.sidebarFooter = new SidebarFooter({
        el: this.sidebarFooter
      });
      this.sidebarFooter.active();
      this.routes({
        "/": function() {
          return this.navigate('/game/list');
        },
        "/game/list": function() {
          this.sidebar.list.active();
          return this.sidebarFooter.active();
        },
        "/game/:id/show": function(params) {
          this.sidebar.show.active(params);
          return this.sidebarFooter.active();
        }
      });
    }
...
}, "controllers/sidebar/Footer": function(exports, require, module) {(function() {
  var $, Footer, Player, Spine,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  Footer = (function(_super) {
    ...
    Footer.prototype.className = 'sidebar-footer';

    Footer.prototype.elements = {
    ...
    function Footer() {
      this.handleEditKeyUp = __bind(this.handleEditKeyUp, this);

      this.handleEditKeyDown = __bind(this.handleEditKeyDown, this);

      this.render = __bind(this.render, this);
      Footer.__super__.constructor.apply(this, arguments);
      this.edited = false;
      this.player = Player.getLocalPlayer();
      this.player.bind('refresh change', this.render);
      this.render();
    }

    Footer.prototype.render = function() {
      this.log("name changed, edited: " + this.edited);
      if (!this.edited) {
        return this.playerName.text(this.player.name);
      } else {
        return this.edited = false;
      }
    };

    Footer.prototype.handleEditKeyDown = function(e) {
      if (e.keyCode === 27 || e.keyCode === 13) {
        return this.playerName.blur();
      }
    };

    Footer.prototype.handleEditKeyUp = function(e) {
      if (e.keyCode !== 27 || e.keyCode !== 13) {
        this.edited = true;
        this.player.updateAttribute("name", this.playerName.text());
      }
      return false;
    };
...
}, "controllers/sidebar/List": function(exports, require, module) {(function() {
  var Game, List, ListItems, Player, Popup, Spine,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  List = (function(_super) {
    ...
    List.CREATE_LAYER_FADE_DURATION = 200;

    List.prototype.className = 'sidebar-list games';
    ...
    function List() {
      ...
      this.html(require('views/sidebar-list')());
      this.popup = new Popup({
        el: this.createGameFormWrapper
      });
    ...
    List.prototype.openCreateLayer = function() {
    ...
    List.prototype.submit = function(e) {
      ...
      game = Game.fromForm(this.createForm);
...
}, "controllers/sidebar/Show": function(exports, require, module) {(function() {
  var Game, Player, Popup, Show, Spine,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  Show = (function(_super) {
    ...
    Show.prototype.className = 'sidebar-show game';

    Show.prototype.currentGame = "";
    ...
    function Show() {
      ...
      Player.bind('refresh change', this.render);
      this.active(this.show);
    }

    Show.prototype.show = function(params) {
    ...
    Show.prototype.render = function() {
      ...
      if (this.currentGame !== "") {
        this.sharePopup = null;
        game = Game.find(this.currentGame);
        this.log(game, Player.find(game.creator));
        viewData = {
          game: game,
          owner: Player.find(game.creator),
          helper: {
            getPlayerName: function(playerId) {
              return Player.find(playerId).name;
            }
          }
        };
        return this.html(require('views/sidebar-show')(viewData));
      }
    };

    Show.prototype.share = function() {
      if (this.sharePopup === null) {
        this.sharePopup = new Popup({
          el: this.jSharePopup
        });
      }
      this.sharePopup.open();
      return this.jShareUrl.val(window.location).focus().select();
    };
...
}, "controllers/sidebar/Sidebar": function(exports, require, module) {(function() {
  var Sidebar, SidebarList, SidebarShow, Spine,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
}, "controllers/sidebar/SidebarListItems": function(exports, require, module) {(function() {
  var Game, MainSidebarListItems, Spine,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  MainSidebarListItems = (function(_super) {

    __extends(MainSidebarListItems, _super);

    MainSidebarListItems.prototype.events = {
      'click tr': 'showGame'
    };

    function MainSidebarListItems() {
      this.render = __bind(this.render, this);
      MainSidebarListItems.__super__.constructor.apply(this, arguments);
      Game.bind('refresh change', this.render);
    }

    MainSidebarListItems.prototype.render = function() {
      var games, html;
      games = Game.all();
      html = games.length > 0 ? require('views/sidebar-list-game')(games) : require('views/sidebar-list-nogame')();
      return this.html(html);
    };

    MainSidebarListItems.prototype.showGame = function(e) {
      var element;
      element = $(e.currentTarget);
      return this.navigate('/game', element.data("item").id, 'show');
    };

    return MainSidebarListItems;
...
}, "controllers/Welcome": function(exports, require, module) {(function() {
  var $, Spine, Welcome,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  Welcome = (function(_super) {
    ...
    function Welcome() {
      ...
      this.html(require('views/welcome')());
    }
...
}, "lib/keycodes": function(exports, require, module) {(function() {
  var keycodes;
...
}, "lib/Popup": function(exports, require, module) {(function() {
  var $, Popup, Spine, keycodes,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  Popup = (function(_super) {
    ...
    function Popup() {
      this.handleKeystroke = __bind(this.handleKeystroke, this);
      Popup.__super__.constructor.apply(this, arguments);
    }

    Popup.prototype.open = function() {
      this.el.fadeIn(Popup.POPUP_FADE_DURATION).prev().fadeIn(Popup.POPUP_FADE_DURATION);
      return $('body').on('keyup.popup', this.handleKeystroke);
    };

    Popup.prototype.close = function() {
      this.el.fadeOut(Popup.POPUP_FADE_DURATION).prev().fadeOut(Popup.POPUP_FADE_DURATION);
      return $('body').off('keyup.popup');
    };

    Popup.prototype.handleKeystroke = function(e) {
  ...
  Game = (function(_super) {
    ...
    Game.configure('Game', 'name', 'creator', 'players', 'state', 'public');

    Game.extend(Spine.Model.Local);

    Game.MAX_PLAYER = 4;

    Game.PLAYER_COLORS = ["#C75233", "#C78933", "#79B5AC", "#5E2F46"];

    Game.prototype.players = [];

    Game.prototype.state = 1;

    Game.prototype.validate = function() {
      if (!this.creator) {
        return "An owner has to be set for a game";
      }
      if (!this.name) {
        return "A game name is required";
      }
      if (!(this.players.length <= Game.MAX_PLAYER)) {
        return "Maximum " + Game.MAX_PLAYER + " players are allowed in a game, not " + this.players.length;
      }
    };

    Game.prototype.addPlayer = function(player) {
      return this.updateAttribute("players", this.players.concat([player.id]));
    };

    Game.prototype.helper = {
      getPlayerColor: function(index) {
        if (index >= Game.PLAYER_COLORS.length) {
          return 'red';
        } else {
          return Game.PLAYER_COLORS[index];
        }
      }
    };
  ...
  Player = (function(_super) {
    ...
    Player.configure('Player', 'name');

    Player.extend(Spine.Model.Local);
...
}, "shared/connectionEvents": function(exports, require, module) {events = {
    PLAYER_UPDATES: 1
};

module.exports = events;}, "views/sidebar-list-game": function(exports, require, module) {module.exports = function(values){ 
  var $  = jQuery, result = $();
  ...
  (function() {
    (function() {
      ...
      __out.push('</strong></td>\n    <td>\n        ');
    
      _ref = this.players;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        player = _ref[_i];
        __out.push('\n        <span class="label" style="background-color: ');
        __out.push(__sanitize(this.helper.getPlayerColor(_i)));
        __out.push(';"><i class="icon-user icon-white"></i></span>\n        ');
      }
  ...
  return result;
};}, "views/sidebar-list-nogame": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "views/sidebar-list": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  (function() {
    (function() {
      ...
      __out.push('    <header>\n        <ul class="breadcrumb">\n            <li class="active">Games</li>\n        </ul>\n        <button class="btn btn-mini btn-primary" title="New Game">+ Create Game</button>\n    </header>\n    <div class="scrollable">\n        <table class="table table-striped">\n            <tbody>\n            </tbody>\n        </table>\n    </div>\n    <footer>\n        Good luck <span class="player-name" contenteditable="true"></span>\n    </footer>\n    <div class="modal-backdrop fade in hide"></div>\n    <div class="new-game-form-wrapper modal hide">\n        <div class="modal-header">\n            <button type="button" class="close" data-dismiss="modal">×</button>\n            <h3>New Game</h3>\n        </div>\n        <div class="modal-body">\n            <form class="form-horizontal">\n                <fieldset>\n                    <legend>Fill the input fields below to create a new game</legend>\n                    <div class="control-group">\n                        <label class="control-label" for="game-public-input">Public game?</label>\n                        <div class="controls">\n                            <label class="checkbox">\n                                <input type="checkbox" name="public" id="game-public-input" checked="checked">\n                                Check, if this game is public.\n                            </label>\n                        </div>\n                    </div>\n                    <div class="control-group">\n                        <label class="control-label" for="game-name-input">Game Name</label>\n                        <div class="controls">\n                            <input type="text" class="input-xlarge" id="game-name-input" name="name" placeholder="A name for your game">\n                            <p class="help-block">Choose a name so friends can find you.</p>\n                        </div>\n                    </div>\n                </fieldset>\n            </form>\n        </div>\n        <div class="modal-footer">\n            <button type="submit" class="save btn btn-primary">Create Game</button>\n        </div>\n    </div>');
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "views/sidebar-show": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  (function() {
    (function() {
      ...
      __out.push('<header xmlns="http://www.w3.org/1999/html">\n    <ul class="breadcrumb">\n        <li>\n            <a href="#/game/list">Games</a> <span class="divider">/</span>\n        </li>\n        <li class="active">');
    
      __out.push(__sanitize(this.game.name));
      ...
      __out.push(__sanitize(this.owner.name));
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        player = _ref[_i];
        __out.push('\n            <dt>Player ');
        __out.push(__sanitize(_i + 1));
        __out.push('</dt>\n            <dd>\n                <span class="label" style="background-color: ');
        __out.push(__sanitize(this.game.helper.getPlayerColor(_i)));
        __out.push(';">\n                    <i class="icon-user icon-white"></i>\n                    ');
        __out.push(__sanitize(this.helper.getPlayerName(player)));
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "views/welcome": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
